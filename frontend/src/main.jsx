...
function App() {
  const beforeNode = useRef(null); const afterNode = useRef(null); const compareNode = useRef(null); const maps = useRef([]); const pending = useRef(null);
  ...
  useEffect(() => {
    ...
    return () => { comparison.remove(); beforeMap.remove(); afterMap.remove(); };
  }, []);
